...
public class RouteOptimizationGUI extends JFrame {
    ...
    private void initializeCitiesAndDistances() {
        ...
        cityPositions.put("Chitwan", new Point(400, 150));
        cityPositions.put("Dharan", new Point(300, 400));
        cityPositions.put("Khotang", new Point(500, 300));
        cityPositions.put("Dhampus", new Point(600, 200));

        // Initialize cities and their indices
        String[] cities = {"Kathmandu", "Pokhara", "Chitwan", "Dharan", "Khotang", "Dhampus"};
        ...
        addConnection("Pokhara", "Chitwan", 250);
        addConnection("Chitwan", "Dharan", 150);
        addConnection("Dharan", "Khotang", 500);
        addConnection("Khotang", "Dhampus", 550);
        addConnection("Dhampus", "Pokhara", 200);
    }
    ...
    private class GraphPanel extends JPanel {
        ...
        private static final Color NODE_COLOR = Color.pink;
